...
public class TestOkHttpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //execute方法测试
        Button btnExecute = findViewById( R.id.btn_okhhtp_execute );
        ...
        //enqueue方法测试
        Button btnEnqueue = findViewById( R.id.btn_okhhtp_enqueue );
        ...
        //登录测试
        Button btnLogin = findViewById( R.id.btn_okhhtp_login );
        ...
        //获取用户信息
        final Button btnGetUserInfo = findViewById( R.id.btn_okhhtp_uerinfo );
        ...
        //修改邮箱
        Button btnUpdateEmail = findViewById( R.id.btn_okhhtp_update_email );
